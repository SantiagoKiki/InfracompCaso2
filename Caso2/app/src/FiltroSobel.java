...
public class FiltroSobel { 
   ...
   public Imagen getImagenIn() {
    return imagenIn;
   }

   public void setImagenIn(Imagen imagenIn) {
   ...
   public void setImagenOut(Imagen imagenOut) {
    this.imagenOut = imagenOut;
   }

   public static int[][] getSobelX() {
    return SOBEL_X;
   }

   public static int[][] getSobelY() {
    return SOBEL_Y;
   }
